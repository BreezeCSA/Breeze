...
public class SMVEditor extends EditorPart {
	public final static String FILE_EXTENSION = "smv";
	public final static String ID = "com.goku.breeze.ui.editor.SMVEditor";
	...
	public void createPartControl(Composite parent) {
		...
		// configure viewer
		viewer.configure(new SMVSourceConfiguration());
	}
