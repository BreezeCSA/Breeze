...
public class DeadlockEditor extends MultiPageEditorPart {
	public static final String FILE_EXTENSION = "deadlock";
	public static final String ID = "com.goku.breeze.editor.DeadlockEditor";
