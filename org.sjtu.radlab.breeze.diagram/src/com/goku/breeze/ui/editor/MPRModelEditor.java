...
import com.goku.breeze.ui.editor.support.ActionAddModeMPR;
import com.goku.breeze.ui.editor.support.ActionNodeAddTransitionMPR;
import com.goku.breeze.ui.editor.support.ActionNodeRmTransitionMPR;
import com.goku.breeze.ui.editor.support.ActionRmModeMPR;
import com.goku.breeze.ui.editor.support.ModeComboSupportMPR;
...
import com.goku.breeze.ui.editor.support.ModeTextSupportMPR;
import com.goku.breeze.ui.editor.support.TransitionComboSupportMPR;
...
public class MPRModelEditor extends ScrolledComposite {
	...
	public MPRModelEditor(String saFilePath, String fileNameWithoutExt, Composite parent, MKVEditor rbdEditor) {
	...
	private void drawPanelForNode(BreezeNode node) {
		...
		modeCol[1].setEditingSupport(new ModeComboSupportMPR(this, this.modeTableViewer));
		...
		TransitionComboSupportMPR[] es = new TransitionComboSupportMPR[] {
				new TransitionComboSupportMPR(this, this.transitionTableViewer, 0, node),
				new TransitionComboSupportMPR(this, this.transitionTableViewer, 1, node),
				new TransitionComboSupportMPR(this, this.transitionTableViewer, 2, node) };
		...
		btnAddTran.addSelectionListener(new ActionNodeAddTransitionMPR(this, node, this.transitionTableViewer));
		btnRmTran.addSelectionListener(new ActionNodeRmTransitionMPR(this, node, this.transitionTableViewer));

		modeCol[0].setEditingSupport(new ModeTextSupportMPR(this, this.modeTableViewer, 0,
				new ColumnViewer[] { this.transitionTableViewer }, new TransitionComboSupportMPR[] { es[0], es[1] }));
		btnRmMode.addSelectionListener(new ActionRmModeMPR(node, this.modeTableViewer,
				new TableViewer[] { this.transitionTableViewer }));

		btnAddMode.addSelectionListener(new ActionAddModeMPR(this, node, this.modeTableViewer, new EditingSupport[] { es[0],
				es[1] }));
