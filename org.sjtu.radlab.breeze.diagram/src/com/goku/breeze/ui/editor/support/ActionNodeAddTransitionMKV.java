...
public class ActionNodeAddTransitionMKV implements SelectionListener {
	private final BreezeNode node;
	private final MKVModelEditor sme;
	private final TableViewer viewer;

	public ActionNodeAddTransitionMKV(MKVModelEditor sme, BreezeNode node, TableViewer viewer) {
		this.node = node;
		this.sme = sme;
		this.viewer = viewer;
	}
