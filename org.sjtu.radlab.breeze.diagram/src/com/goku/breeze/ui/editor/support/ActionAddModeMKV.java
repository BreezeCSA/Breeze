...
public class ActionAddModeMKV implements SelectionListener {
	private final EditingSupport[] es;
	private final BreezeNode node;
	private final MKVModelEditor sme;
	private final TableViewer viewer;

	public ActionAddModeMKV(MKVModelEditor sme, BreezeNode container, TableViewer modeTableViewer, EditingSupport[] cols) {
		this.node = container;
