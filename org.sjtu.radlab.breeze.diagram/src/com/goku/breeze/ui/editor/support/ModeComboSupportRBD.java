...
public class ModeComboSupportRBD extends EditingSupport {
	private static final String[] ModeType = new String[] { BreezeMode.TYPE_INITIAL, BreezeMode.TYPE_NORMAL,
			BreezeMode.TYPE_STOP, BreezeMode.TYPE_FAILURE };
	private ComboBoxViewerCellEditor cellEditor = null;
	private final RBDModelEditor sme;
	private final ColumnViewer viewer;

	public ModeComboSupportRBD(RBDModelEditor rbdModelEditor, ColumnViewer viewer) {
		super(viewer);
		// TODO Auto-generated constructor stub
		this.viewer = viewer;
		this.sme = rbdModelEditor;
