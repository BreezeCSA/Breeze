...
public class ActionAddModeMPR implements SelectionListener {
	private final EditingSupport[] es;
	private final BreezeNode node;
	private final MPRModelEditor sme;
	private final TableViewer viewer;

	public ActionAddModeMPR(MPRModelEditor sme, BreezeNode container, TableViewer modeTableViewer, EditingSupport[] cols) {
		this.node = container;
