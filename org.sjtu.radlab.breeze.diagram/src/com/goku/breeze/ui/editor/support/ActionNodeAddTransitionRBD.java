...
public class ActionNodeAddTransitionRBD implements SelectionListener {
	private final BreezeNode node;
	private final RBDModelEditor sme;
	private final TableViewer viewer;

	public ActionNodeAddTransitionRBD(RBDModelEditor sme, BreezeNode node, TableViewer viewer) {
		this.node = node;
		this.sme = sme;
		this.viewer = viewer;
	}
