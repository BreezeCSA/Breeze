...
public class ModeTextSupportMPR extends EditingSupport {
	private TextCellEditor cellEditor = null;
	private final int columnIndex;
	private final ColumnViewer[] refreshViewer;
	private final MPRModelEditor sme;
	private final TransitionComboSupportMPR[] tcs;
	private final ColumnViewer viewer;

	public ModeTextSupportMPR(MPRModelEditor sme, ColumnViewer viewer, int columnIndex, ColumnViewer[] refreshViewer,
			TransitionComboSupportMPR[] tcs) {
		super(viewer);
	...
	protected void setValue(Object element, Object value) {
		...
		case 0:
			...
			if (!value.toString().equals(bm.getId())) {
				...
				if (this.tcs != null) {
					for (TransitionComboSupportMPR tc : this.tcs)
						tc.updateInput();
				}
