...
public class TransitionComboSupportMPR extends EditingSupport {
	...
	public TransitionComboSupportMPR(MPRModelEditor sme, ColumnViewer viewer, int columnIndex, BreezeNode node) {
		super(viewer);
