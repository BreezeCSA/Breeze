...
public class TransitionComboSupportRBD extends EditingSupport {
	...
	public TransitionComboSupportRBD(RBDModelEditor sme, ColumnViewer viewer, int columnIndex, BreezeNode node) {
		super(viewer);
