...
public class ActionNodeRmTransitionMPR implements SelectionListener {
	private final BreezeNode node;
	private final MPRModelEditor sme;
	private final TableViewer viewer;

	public ActionNodeRmTransitionMPR(MPRModelEditor sme, BreezeNode node, TableViewer viewer) {
		this.node = node;
		this.sme = sme;
		this.viewer = viewer;
	}
