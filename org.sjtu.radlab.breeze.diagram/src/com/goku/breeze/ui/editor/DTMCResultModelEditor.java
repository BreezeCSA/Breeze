...
public class DTMCResultModelEditor extends ScrolledComposite {
	...
	public static Map parseXml(File filePath) throws DocumentException {
		...
		while (it.hasNext()) {
			...
			{
				if (element.attributeValue("isVirtual").toString().equals("0"))
				{
				idmap.put(element.attributeValue("ID")+"-c", element.attributeValue("name")+"-c");
				idmap.put(element.attributeValue("ID")+"-i", element.attributeValue("name")+"-i");
				}
				else 
				{
	...
	public static Map parseXmlc1(File filePath) throws DocumentException {
		...
		while (it.hasNext()) {
			...
			// System.out.println(element);
			{
				if (element.attributeValue("isVirtual").toString().equals("0"))
				{
				idmapc1.put(element.attributeValue("ID")+"-cc", element.attributeValue("sourceName")+"-c");
				idmapc1.put(element.attributeValue("ID")+"-ic", element.attributeValue("sourceName")+"-c");
				idmapc1.put(element.attributeValue("ID")+"-ci", element.attributeValue("sourceName")+"-i");
				idmapc1.put(element.attributeValue("ID")+"-ii", element.attributeValue("sourceName")+"-i");
				}
				else if (element.attributeValue("isVirtual").toString().equals("1"))
				{
					idmapc1.put(element.attributeValue("ID")+"-cn", element.attributeValue("sourceName"));
					idmapc1.put(element.attributeValue("ID")+"-in", element.attributeValue("sourceName"));					
				}
				else 
				{
					idmapc1.put(element.attributeValue("ID")+"-nc", element.attributeValue("sourceName"));
					idmapc1.put(element.attributeValue("ID")+"-ni", element.attributeValue("sourceName"));					
				}
			}
		}
	...
	public static Map parseXmlc2(File filePath) throws DocumentException {
		...
		while (it.hasNext()) {
			...
			// System.out.println(element);
			{
				if (element.attributeValue("isVirtual").toString().equals("0"))
				{
					idmapc2.put(element.attributeValue("ID")+"-cc", element.attributeValue("targetName")+"-c");
					idmapc2.put(element.attributeValue("ID")+"-ic", element.attributeValue("targetName")+"-i");
					idmapc2.put(element.attributeValue("ID")+"-ci", element.attributeValue("targetName")+"-c");
					idmapc2.put(element.attributeValue("ID")+"-ii", element.attributeValue("targetName")+"-i");
				}
				else if (element.attributeValue("isVirtual").toString().equals("1"))
				{
					idmapc2.put(element.attributeValue("ID")+"-cn", element.attributeValue("targetName"));
					idmapc2.put(element.attributeValue("ID")+"-in", element.attributeValue("targetName"));					
				}
				else 
				{
					idmapc2.put(element.attributeValue("ID")+"-nc", element.attributeValue("targetName"));
					idmapc2.put(element.attributeValue("ID")+"-ni", element.attributeValue("targetName"));					
				}
			}
		}
	...
	public static Map parseXmlc3(File filePath) throws DocumentException {
		...
		while (it.hasNext()) {
			...
			// System.out.println(element);
			{
				if (element.attributeValue("isVirtual").toString().equals("0"))
				{
					idmapc3.put(element.attributeValue("ID")+"-cc", element.attributeValue("probability"));
					idmapc3.put(element.attributeValue("ID")+"-ic", element.attributeValue("probability"));
					idmapc3.put(element.attributeValue("ID")+"-ci", element.attributeValue("probability"));
					idmapc3.put(element.attributeValue("ID")+"-ii", element.attributeValue("probability"));
				}
				else if (element.attributeValue("isVirtual").toString().equals("1"))
				{
					idmapc3.put(element.attributeValue("ID")+"-cn", element.attributeValue("probability"));
					idmapc3.put(element.attributeValue("ID")+"-in", element.attributeValue("probability"));					
				}
				else 
				{
					idmapc3.put(element.attributeValue("ID")+"-nc", element.attributeValue("probability"));
					idmapc3.put(element.attributeValue("ID")+"-ni", element.attributeValue("probability"));					
				}
			}
		}
	...
	public static Map parseXmlp(File filePath) throws DocumentException {
		...
		while (it.hasNext()) {
			...
			// System.out.println(element);
			{
				if (element.attributeValue("isVirtual").toString().equals("0"))
				{
					idmapp.put(element.attributeValue("ID")+"-c", element.attributeValue("pcc"));
					idmapp.put(element.attributeValue("ID")+"-i", element.attributeValue("pcc"));
				}
				else 
				{
					idmapp.put(element.attributeValue("ID"), element.attributeValue("pcc"));
				}
			}
		}
		return mapEle;
	...
	public static Map parseXmlv(File filePath) throws DocumentException {
		...
		while (it.hasNext()) {
			...
			// System.out.println(element);
			{
				if (element.attributeValue("isVirtual").toString().equals("0"))
				{
					idmapv.put(element.attributeValue("ID")+"-c", element.attributeValue("isVirtual"));
					idmapv.put(element.attributeValue("ID")+"-i", element.attributeValue("isVirtual"));
				}
				else 
				{
	...
	public DTMCResultModelEditor(String saFilePath, String fileNameWithoutExt, Composite parent, DTMCEditor dtmcEditor) {
...
//						vcount = vcount + 1;
//						idmapn.put(entryv.getKey()+"-i", String.valueOf(vcount));
					}
