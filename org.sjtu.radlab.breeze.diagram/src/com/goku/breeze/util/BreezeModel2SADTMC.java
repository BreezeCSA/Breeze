...
public class BreezeModel2SADTMC {
	...
	private void recurseConvert(Element element, BreezeArch arch) {
		...
		childEle.addAttribute("pcc", "1");
		childEle.addAttribute("pic", "0");
		childEle.addAttribute("pnc", "0");
		childEle.addAttribute("pci", "0");
		childEle.addAttribute("pii", "1");
		childEle.addAttribute("pni", "0");
		...
		childEle.addAttribute("probability", "1");
		childEle.addAttribute("isVirtual", "2");
...
//			childEle.addAttribute("selfLoopProbability", "1");
			...
			for (String portKey : portMap.keySet()) {
				...
				edgeEle.addAttribute("isVirtual", "1");
				...
				edgeEle.addAttribute("probability", "1");
				edgeEle.addAttribute("isVirtual", "2");
				...
				edgeEle.addAttribute(BreezeObject.ATTR_TARGET_PORT,bn.getId()+"SourcePort");
				edgeEle.addAttribute("probability", "0");
				edgeEle.addAttribute("isVirtual", "3");
