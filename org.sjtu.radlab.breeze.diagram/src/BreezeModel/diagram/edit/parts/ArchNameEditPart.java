 ...
 * @generated
 */
public class ArchNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArchNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BreezeModel.diagram.providers.BreezeParserProvider.getParser(
					BreezeModel.diagram.providers.BreezeElementTypes.Arch_2001, getParserElement(),
