 ...
 * @generated
 */
public class TemplateNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TemplateNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BreezeModel.diagram.providers.BreezeParserProvider.getParser(
					BreezeModel.diagram.providers.BreezeElementTypes.Template_3010, getParserElement(),
