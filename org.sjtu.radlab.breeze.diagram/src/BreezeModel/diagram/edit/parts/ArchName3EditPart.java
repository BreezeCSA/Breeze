 ...
 * @generated
 */
public class ArchName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArchName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BreezeModel.diagram.providers.BreezeParserProvider.getParser(
					BreezeModel.diagram.providers.BreezeElementTypes.Arch_3013, getParserElement(),
