 ...
 * @generated
 */
public class NodeTemplateEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NodeTemplateEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BreezeModel.diagram.edit.policies.NodeTemplateItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BreezeModel.diagram.edit.parts.NodeTemplateNameEditPart) {
			((BreezeModel.diagram.edit.parts.NodeTemplateNameEditPart) childEditPart).setLabel(getPrimaryShape()
