 ...
 * @generated
 */
public class GokuDocumentationPowerEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GokuDocumentationPowerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new BreezeModel.diagram.edit.policies.BreezeTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return BreezeModel.diagram.providers.BreezeElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BreezeModel.diagram.providers.BreezeParserProvider.getParser(
					BreezeModel.diagram.providers.BreezeElementTypes.Goku_2003, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					BreezeModel.diagram.edit.parts.BreezeEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
