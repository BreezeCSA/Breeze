 ...
 * @generated
 */
public class ProductionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProductionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BreezeModel.diagram.providers.BreezeParserProvider.getParser(
					BreezeModel.diagram.providers.BreezeElementTypes.Production_3011, getParserElement(),
