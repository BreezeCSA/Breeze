 ...
 * @generated
 */
public class NodeTemplateNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NodeTemplateNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BreezeModel.diagram.providers.BreezeParserProvider.getParser(
					BreezeModel.diagram.providers.BreezeElementTypes.NodeTemplate_3009, getParserElement(),
