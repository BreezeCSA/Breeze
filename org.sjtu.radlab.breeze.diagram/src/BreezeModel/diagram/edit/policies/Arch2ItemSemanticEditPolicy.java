 ...
 * @generated
 */
public class Arch2ItemSemanticEditPolicy extends BreezeModel.diagram.edit.policies.BreezeBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Arch2ItemSemanticEditPolicy() {
		super(BreezeModel.diagram.providers.BreezeElementTypes.Arch_3012);
	}
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			case BreezeModel.diagram.edit.parts.ArchContentCompartment2EditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					switch (BreezeModel.diagram.part.BreezeVisualIDRegistry.getVisualID(cnode)) {
