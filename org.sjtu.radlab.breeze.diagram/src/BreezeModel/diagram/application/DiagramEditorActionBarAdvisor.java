...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menu) {
		...
		{
			IMenuManager menuX = new MenuManager(BreezeModel.diagram.part.Messages.ApplicationMenuName_File,
					IWorkbenchActionConstants.M_FILE);

			menuX.add(new GroupMarker(IWorkbenchActionConstants.FILE_START));

			{
				IMenuManager menuXX = new MenuManager(BreezeModel.diagram.part.Messages.ApplicationMenuName_New, "new");
		...
		{
			IMenuManager menuX = new MenuManager(BreezeModel.diagram.part.Messages.ApplicationMenuName_Edit,
		...
		{
			IMenuManager menuX = new MenuManager(BreezeModel.diagram.part.Messages.ApplicationMenuName_Window,
		...
		{
			IMenuManager menuX = new MenuManager(BreezeModel.diagram.part.Messages.ApplicationMenuName_Help,
	...
	private static boolean openEditor(IWorkbench workbench, URI fileURI) {
		...
		if (editorDescriptor == null) {
			MessageDialog.openError(
					...
					BreezeModel.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorTitle,
					NLS.bind(BreezeModel.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorMessage,
			...
			try {
				...
				MessageDialog.openError(workbenchWindow.getShell(),
						BreezeModel.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultEditorOpenErrorTitle,
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			BreezeModel.diagram.part.BreezeCreationWizard wizard = new BreezeModel.diagram.part.BreezeCreationWizard();
	...
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MessageDialog.openInformation(getWindow().getShell(),
					BreezeModel.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogTitle,
					BreezeModel.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogMessage);
		}
	}
