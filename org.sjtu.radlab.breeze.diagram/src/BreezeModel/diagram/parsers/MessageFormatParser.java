package BreezeModel.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(BreezeModel.diagram.part.BreezeDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
					NLS.bind(BreezeModel.diagram.part.Messages.MessageFormatParser_InvalidInputError,
