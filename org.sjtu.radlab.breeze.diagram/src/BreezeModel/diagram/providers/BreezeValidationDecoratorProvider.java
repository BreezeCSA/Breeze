 ...
 * @generated
 */
public class BreezeValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof BreezeModel.diagram.part.BreezeDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& BreezeModel.diagram.edit.parts.BreezeEditPart.MODEL_ID.equals(BreezeModel.diagram.part.BreezeVisualIDRegistry
						.getModelID(view));
	}
		...
		PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					BreezeModel.diagram.part.BreezeDiagramEditorPlugin.getInstance().logError("Decorator refresh failure", e); //$NON-NLS-1$
				}
			}
		});
	}
	...
	public static class StatusDecorator extends AbstractDecorator {
		...
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				BreezeModel.diagram.part.BreezeDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
			}
		}
		...
		public void refresh() {
			...
			BreezeModel.diagram.part.ValidationMarker foundMarker = null;
			BreezeModel.diagram.part.ValidationMarker[] markers = BreezeModel.diagram.part.ValidationMarker.getMarkers(
			...
			for (int i = 0; i < markers.length; i++) {
				BreezeModel.diagram.part.ValidationMarker marker = markers[i];
