 ...
 * @generated
 */
public abstract class BreezeAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = BreezeModel.diagram.part.BreezeDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected BreezeAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
