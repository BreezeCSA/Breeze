...
/**
 * This is the item provider adapter for a {@link BreezeModel.NodeInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeInstance_TR_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeInstance_TR_feature", "_UI_NodeInstance_type"),
				 breezePackage.Literals.NODE_INSTANCE__TR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAvailabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeInstance_availability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeInstance_availability_feature", "_UI_NodeInstance_type"),
				 breezePackage.Literals.NODE_INSTANCE__AVAILABILITY,
				 true,
				 false,
				 false,
