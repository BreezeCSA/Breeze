...
/**
 * This is the item provider adapter for a {@link BreezeModel.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 breezePackage.Literals.METHOD__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		AccessType labelValue = ((Method)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Method.class)) {
			case breezePackage.METHOD__TYPE:
